...
namespace workflow
{
    ...
    public class screenConstructor
    {
        ...
        {
            List<string> labelLeftChats = new List<string>() { "Чаты: " };
            List<string> conversationNames = new List<string>();
            List<string> labelLeftChatsAfter = new List<string>() { "+ Добавить чаты" };
        ...
        public static void setMainLeftPanel(workflow.main_form connectForm)
        {
            ...
            connectForm.a_main_screen_left_panel_logo_box.Visible = true;
            connectForm.a_main_screen_left_panel_logo_emli_box.Visible = true;
            if (connectForm.a_main_screen_left_panel_progress_emli_box.Value > 0)
            {
                connectForm.a_main_screen_left_panel_label_emli_box.Visible = true;
        ...
        public static void setDocumentsMainScreenVersion(string senderButton, workflow.main_form connectForm)
        {
            ...
            switch (senderButton)
            {
                case "a_incoming_messages_button":
                    ...
                    propertiesDocuments.Add(0, Color.FromArgb(173, 231, 255));
                ...
                case "a_document_templates_button":
                    ...
                    propertiesTemplates.Add(0, Color.FromArgb(173, 231, 255));
        ...
        public static void setMainScreenVersion(workflow.main_form connectForm)
        {
            ...
            propertiesMain.Add(0, Color.FromArgb(173, 231, 255));
        ...
        {
            connectForm.a_main_screen_top_panel_button1_text.ForeColor = System.Drawing.Color.FromArgb(51, 153, 255);
            connectForm.a_main_screen_top_panel_button2_text.ForeColor = System.Drawing.Color.FromArgb(51, 153, 255);
            connectForm.a_main_screen_top_panel_button3_text.ForeColor = System.Drawing.Color.FromArgb(51, 153, 255);

            connectForm.a_main_screen_top_panel_button1.BackColor = Color.White;
            connectForm.a_main_screen_top_panel_button2.BackColor = Color.White;
            connectForm.a_main_screen_top_panel_button3.BackColor = Color.White;

            connectForm.a_main_screen_top_panel_button1.BorderStyle = BorderStyle.FixedSingle;
            connectForm.a_main_screen_top_panel_button2.BorderStyle = BorderStyle.FixedSingle;
            connectForm.a_main_screen_top_panel_button3.BorderStyle = BorderStyle.FixedSingle;

            labelToSetActive.ForeColor = System.Drawing.Color.FromArgb(255, 255, 255);
            labelToSetActive.Parent.BackColor = System.Drawing.Color.FromArgb(51, 153, 255);
            ((Panel)labelToSetActive.Parent).BorderStyle = BorderStyle.None;
            //labelToSetActive.Parent.BackgroundImage = 
        }
        ...
        public static void resetChatsLeftPanelButtonsColors(workflow.main_form connectForm)
        {
            foreach(Conversation conversation in main_form.User.conversations)
            {
                main_form.User.systemData[conversation.id.ToString()].ForeColor = System.Drawing.Color.FromArgb(51, 153, 255);
                main_form.User.systemData[conversation.id.ToString()].BackColor = System.Drawing.Color.FromArgb(255, 255, 255);
            }

            main_form.User.systemData[main_form.User.currentConversationId].ForeColor = System.Drawing.Color.FromArgb(51, 153, 204);
            main_form.User.systemData[main_form.User.currentConversationId].BackColor = System.Drawing.Color.FromArgb(235, 240, 245);
        }
    ...
    public class mainBox
    {
        ...
        public static int addElementsChats(List<Message> elements, Conversation conversation, Panel mainBox, workflow.main_form connectForm)
        {
            ...
            for (int num = 0; num < elements.Count(); num++)
            {
                ...
                author.TextAlign = ContentAlignment.MiddleCenter;
                author.BackColor = Color.FromArgb(173, 231, 255);
